...
export class Filter implements FilterInterface {
  private constructor(genres: number[], maxNo: number, minNo: number, firstUpdate: Date | undefined, enableTanpen: boolean, enableRensai: boolean, enableKanketsu: boolean) {
    this._genres = genres;
    this._maxNo = maxNo;
    this._minNo = minNo;
  ...
  static init() {
    ...
    return new Filter(genre, maxNo, minNo, isValid(_firstUpdate) ? _firstUpdate : undefined, enableTanpen, enableRensai, enableKanketsu);
  }
  execute(items: RankingResult[]) {
    return items
      ...
      .filter(item => !this.firstUpdate ||
        isBefore(this.firstUpdate, parse(item.general_firstup, narouDateFormat, new Date())))
      .filter(item => (this.enableTanpen && item.novel_type === 2) ||
  ...
  setGenres(genres: number[]) {
    ...
    return new Filter(genres, this.maxNo, this.minNo, this.firstUpdate, this.enableTanpen, this.enableRensai, this.enableKanketsu);
  }
  get maxNo() {
    return this._maxNo;
  }
  setMaxNo(maxNo: number) {
    ...
    return new Filter(this.genres, maxNo, this.minNo, this.firstUpdate, this.enableTanpen, this.enableRensai, this.enableKanketsu);
  }
  get minNo() {
    return this._minNo;
  }
  setMinNo(minNo: number) {
    ...
    return new Filter(this.genres, this.maxNo, minNo, this.firstUpdate, this.enableTanpen, this.enableRensai, this.enableKanketsu);
  }
  get firstUpdate() {
  ...
  setFirstUpdate(firstUpdate: Date | undefined) {
    ...
    return new Filter(this.genres, this.maxNo, this.minNo, firstUpdate, this.enableTanpen, this.enableRensai, this.enableKanketsu);
  }
  get enableTanpen() {
  ...
  setEnableTanpen(enableTanpen: boolean) {
    ...
    return new Filter(this.genres, this.maxNo, this.minNo, this.firstUpdate, enableTanpen, this.enableRensai, this.enableKanketsu);
  }
  get enableRensai() {
  ...
  setEnableRensai(enableRensai: boolean) {
    ...
    return new Filter(this.genres, this.maxNo, this.minNo, this.firstUpdate, this.enableTanpen, enableRensai, this.enableKanketsu);
  }
  get enableKanketsu() {
  ...
  setEnableKanketsu(enableKanketsu: boolean) {
    ...
    return new Filter(this.genres, this.maxNo, this.minNo, this.firstUpdate, this.enableTanpen, this.enableRensai, enableKanketsu);
  }
}
